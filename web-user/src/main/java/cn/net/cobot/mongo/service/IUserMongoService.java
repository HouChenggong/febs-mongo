...
public interface IUserMongoService {
     ...
     * @return 用户
     */
    UserMongo findByName(String username);
     ...
     * @return IPage
     */
    ResponseResult findUserDetail(UserMongo user, QueryRequest request);
     ...
     * @return 用户信息
     */
    UserMongo findUserDetail(String username);
     ...
     * @param user user
     */
    void createUser(UserMongo user);
     ...
     * @param user user
     */
    void updateUser(UserMongo user);
     ...
     * @param user 个人信息
     */
    void updateProfile(UserMongo user);
}
